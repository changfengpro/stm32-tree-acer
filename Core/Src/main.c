...
Motor_Init_Config_s DMmotor = {
    ...
    .can_init_config.id = 0x0F,
    .can_init_config.rx_id = 0x00,
    .can_init_config.tx_id = 0x0F,
    
    .controller_param_init_config.speed_PID.Kp = 0.1,
    .controller_param_init_config.speed_PID.Kd = 0.01,
};
